	...
	case 'verusuarios':
					...
					<ul class="nav">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="slider">
								<ul class="nav nav-collapse">
									<li>
									<a href="{{route('Slider.indexVariable', 'inicio')}}">
										<span class="sub-item">Inicio</span>
									</a>
									</li>
									<li>
									<a href="{{route('Slider.indexVariable', 'quienes-somos')}}">
										<span class="sub-item">Quienes somos</span>
									</a>
									</li>
									<li>
									<a href="{{route('Slider.indexVariable', 'productos')}}">
										<span class="sub-item">Productos</span>
									</a>
									</li>
									<li>
									<a href="{{route('Slider.indexVariable', 'distribuidores')}}">
										<span class="sub-item">Distribuidores</span>
									</a>
									</li>
									<li>
									<a href="{{route('Slider.indexVariable', 'servicios')}}">
										<span class="sub-item">Servicios</span>
									</a>
									</li>
									<li>
									<a href="{{route('Slider.indexVariable', 'documentos')}}">
										<span class="sub-item">Documento</span>
									</a>
									</li>
									<li>
									<a href="{{route('Slider.indexVariable', 'contacto')}}">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="producto">
								<ul class="nav nav-collapse">
									<li>
									<a href="{{route('ProductosAdminCategorias.index')}}">
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#marcas">
								<i class="fas fa-home"></i>
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#quinesSomos">
								<i class="fas fa-home"></i>
								<p>Quienes somos</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="quinesSomos">
								<ul class="nav nav-collapse">
									<li>
									<a href="{{route('QuienesSomosAdmin.index')}}">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="documentos">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="{{route('documentos-subcategorias.index')}}">
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#logos">
								<i class="fas fa-home"></i>
								<p>Logos</p>
								<span class="caret"></span>
							</a>
		...
		<div class="main-panel">
			<div class="content">
                @yield('contenido')
                @if (Request::is('home'))
        			<h1 class="text-center mt-5">Welcome:<br> {{Auth::user()->username}}</h1>
            	@endif
